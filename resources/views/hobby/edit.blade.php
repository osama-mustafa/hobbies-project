        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form autocomplete="off" method="post" action="{{ route('hobby.update', $hobby->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-2">
                                ...
                                <a class="btn btn-outline-danger float-right" href="{{route('delete.images', $hobby->id)}}">Delete Image</a>
                            </div>
                            @endif
